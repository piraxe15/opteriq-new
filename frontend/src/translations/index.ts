...
export const translations: Record<Language, Translations> = {
  ...
  en: {
    ...
    contact: {
      ...
      info: {
        ...
        quickResponse: "Response within 24h guaranteed"
      }
    },
    toast: {
      ...
      error: "Error",
      errorDescription: "An error occurred. Please try again or contact us directly."
    },
    modernCta: {
  ...
  es: {
    ...
    toast: {
      ...
      error: "Error",
      errorDescription: "Ocurrió un error. Por favor inténtalo de nuevo o contáctanos directamente."
    },
    modernCta: {
